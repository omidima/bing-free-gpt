...
class optionsSets:
    '''
    # Class for bot options

    jailbreak -> a models of bot response
    '''
    optionSet: dict = {
        'tone': str,
        'optionsSets': list
...
class Defaults:
    '''
    # Default setting of bing chat bot
    '''

    delimiter = '\x1e'

    # your server ip address
    # Default: for work currectly we need to set US ip address.
...
async def create_conversation():
    '''
    # Create init request session

    get cookies and header of a first request for set in request client and authorize sending data on server
    '''
...
def _create_completion( messages: list, **kwargs):
    ...
    """The sample function for start bot conversation

    Attributes
    ----------
    messages: list
        list of messages. message is a json object same this
        '''json
        {
            "role": "assistant|user"
            "content: "string"
